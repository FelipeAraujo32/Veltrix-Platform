...
export const routes: Routes = [
 {path:'',loadComponent:()=>import('./features/inicio/inicio').then(m=>m.Inicio),title:'Veltrix — Sistemas de gestão integrados em um só acesso'},
 ...
 {path:'privacidade',loadComponent:()=>import('./features/legal/privacidade').then(m=>m.PrivacidadePage),title:'Política de Privacidade — Veltrix',data:{seo:{description:'Como a Veltrix trata dados pessoais no site e na Área do cliente: bases legais da LGPD, prazos de guarda, compartilhamento e seus direitos como titular.'}}},
 {path:'termos',loadComponent:()=>import('./features/legal/termos').then(m=>m.TermosPage),title:'Termos de Uso — Veltrix',data:{seo:{description:'Condições para usar o site e a Área do cliente da Veltrix: conta e acesso, uso aceitável, dados pessoais, disponibilidade, propriedade intelectual e foro.'}}},
